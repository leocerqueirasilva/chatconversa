...
To track conversions for your Google Ad, you can add a Google Analytics block whenever you'd like to trigger the conversion evento com the following properties:
