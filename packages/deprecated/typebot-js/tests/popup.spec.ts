...
describe('initPopup', () => {
  ...
  it('should return the popupElement with lazy iframe', () => {
    expect.assertions(2)
    initPopup({ url: 'https://chatresponde.site/typebot-id' })
  ...
  it('should overwrite if exists', () => {
    expect.assertions(2)
    initPopup({
      url: 'https://chatresponde.site/typebot-id',
  ...
  it('should have the opened classname after the delay', async () => {
    expect.assertions(2)
    initPopup({ delay: 500, url: 'https://chatresponde.site/typebot-id' })
    const popupElement = document.getElementById('typebot-popup')
    expect(popupElement?.classList.contains('opened')).toBe(false)
...
describe('openPopup', () => {
  ...
  it('should add opened className and lazy load', () => {
    expect.assertions(5)
    const { open } = initPopup({ url: 'https://chatresponde.site/typebot-id' })
    const popupElement = document.getElementById('typebot-popup')
...
describe('closePopup', () => {
  ...
  it('shouldn remove opened className', () => {
    expect.assertions(2)
    const { close } = initPopup({ url: 'https://chatresponde.site/typebot-id' })
    const popupElement = document.getElementById('typebot-popup')
    close()
    expect(popupElement?.classList.contains('opened')).toBe(false)
